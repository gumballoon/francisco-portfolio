...
export default function SkillsIcon({ SVG, width, description } ) {
    return (
        ...
        <span className='block mt-2 font-extralight opacity-0 peer-hover:opacity-100 peer-focus:opacity-100 transition-opacity duration-300' aria-hidden='true'>{description}</span>
    </div>
    )
} 